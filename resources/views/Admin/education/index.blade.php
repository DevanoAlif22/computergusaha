...
@section('content')
<div class="container">
  <h4 class="mb-3">Manajemen Education</h4>
  ...
  <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap mb-3">
    ...
    <form method="GET" action="{{ route('admin.education.index') }}" class="d-flex align-items-center gap-2 w-full">
      ...
      @if(($q ?? '') !== '' || ($sort ?? 'desc') !== 'desc')
        <a href="{{ route('admin.education.index') }}" class="btn btn-outline-secondary">Reset</a>
      @endif
    ...
    <table class="table table-bordered table-striped align-middle">
      ...
      <tbody>
        ...
        <tr>
          <td>
            @if($item->gambar)
              <img src="{{ asset('storage/'.$item->gambar) }}" width="120" class="img-thumbnail" alt="education">
            @else
          ...
          <td>
            ...
            <form action="{{ route('admin.education.destroy', $item->id) }}" method="POST" class="d-inline delete-form">
              @csrf @method('DELETE')
        ...
        <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content" style="overflow-y:auto">
              <form action="{{ route('admin.education.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
                ...
                <div class="modal-body">
                  <div class="mb-3">
                    ...
                    @if($item->gambar)
                      <img src="{{ asset('storage/'.$item->gambar) }}" width="120" class="mb-2 img-thumbnail" alt="education">
                    @endif
