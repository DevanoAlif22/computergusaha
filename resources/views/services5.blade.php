            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                            <li><a class="dropdown-item" href="{{ url('/home-it-solutions2') }}">It Solution Creative</a></li>
                            <li><a class="dropdown-item" href="{{ url('/home-app-landing') }}">App Landing</a></li>
                            <li><a class="dropdown-item" href="{{ url('/home-saas-technology') }}">Saas Technology</a></li>
                            <li><a class="dropdown-item" href="{{ url('/home-marketing-startup') }}">Marketing Startup</a></li>
                            <li><a class="dropdown-item" href="{{ url('/home-it-solutions') }}">It Solution</a></li>
                            <li><a class="dropdown-item" href="{{ url('/home-software-company') }}">Software Company</a></li>
                            <li><a class="dropdown-item" href="{{ url('/home-digital-agency') }}">Digital Agency</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                            <li><a class="dropdown-item" href="{{ url('/about2') }}">About</a></li>
                            <li><a class="dropdown-item" href="{{ url('/product-5') }}">Product</a></li>
                            <li><a class="dropdown-item" href="{{ url('/services-5') }}">Services</a></li>
                            <li><a class="dropdown-item" href="{{ url('/shop-5') }}">Shop</a></li>
                            <li><a class="dropdown-item" href="{{ url('/single-project-5') }}">Single Project</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                          <a class="nav-link" href="{{ url('/portfolio-5') }}">
                          Portfolio
                          </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{ url('/blog-5') }}">
                          Blog
                          <small
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/contact-5') }}">
                            Contact Us
                        </a>
                    </li>
                ...
                <div class="nav-side">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ url('/start-trial') }}" class="btn rounded-pill blue5-3Dbutn hover-blue2 sm-butn fw-bold">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="#" class="testi-card style-5">
                                    ...
                                    <div class="text">
                                        “Best dashboard for any your store, woo or shopify.  Powerful and very flexiable. Recommended!”
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="testi-card style-5">
                                    ...
                                    <div class="text">
                                        “Big thank to team support of Iteck. Fast, professional and extremly friendly. This product alway update and ehance everyday.”
                                    </div>
                                    <div class="user mt-40 text-center">
                                        <div class="icon-80 rounded-circle img-cover overflow-hidden m-auto">
