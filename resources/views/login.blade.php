                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="slide-card">
                                                ...
                                                <div class="img">
                                                    <img src="assets/img/logo_otw/1.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="slide-card">
                                                <!-- <h3> Welcome To Iteck <br> Community </h3> -->
                                                <div class="img">
                                                    <img src="assets/img/logo_otw/2.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="slide-card">
                                                <!-- <h3> Welcome To Iteck <br> Community </h3> -->
                                                <div class="img">
                                                    <img src="assets/img/logo_otw/3.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="slide-card">
                                                <!-- <h3> Welcome To Iteck <br> Community </h3> -->
                                                <div class="img">
                                                    <img src="assets/img/logo_otw/4.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="slide-card">
                                                <!-- <h3> Welcome To Iteck <br> Community </h3> -->
                                                <div class="img">
                                                    <img src="assets/img/logo_otw/5.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
